...
set(0,'Units','pixels');
sz = get(0,'ScreenSize');
topfig = figure('Name','AeroMorph v.5.0','NumberTitle','on','Position',[(sz(3)-1024)/2 (sz(4)-640)/2 1024 640],'MenuBar','None','Visible','off');
set(topfig, 'color', [0 0 0]); % [.2 .4 1]
frame1 = uipanel('Parent',topfig,'Position',[.025 .025 .95 .95],'BackgroundColor',[.85 0 0]);
uicontrol('Parent',topfig,'Style','text','String',strcat([char(169) '2008-2009 Cody Lafountain, University of Cincinnati']),'Position',[2,0,350,15],'BackgroundColor','Black','ForegroundColor',[1 1 1],'HorizontalAlignment','Left','FontName','@Arial UnicodeMS','FontUnits','points','FontSize',8);
...
%Data Box
 ...
 %Column 1
    ...
    uicontrol('Parent',subframe2,'Style','text','String','ThicknessChange','Position',[10,110,150,20],'BackgroundColor',[1 1 1],'FontName','@Arial Unicode MS','FontUnits','points','FontSize',10,'FontWeight','Bold');
...
%Run Figure
    run_fig = figure('Name','AeroMorph v.5.0|GenerateRun','NumberTitle','off','Position',[(sz(3)-374)/2 (sz(4)-320)/2 374 320],'MenuBar','None','Visible','off');
...
%Merge Figure
    ...
    int_fig = figure('Name','AeroMorph v.5.0|MergeAirfoils','NumberTitle','off','Position',[(sz(3)-374)/2 (sz(4)-142)/2 374 142],'MenuBar','None','Visible','off');
    ...
    int_airfoil_percent1 = uicontrol('Parent',int_frame2,'Style','text','String',strcat(num2str(get(int_airfoil_slider,'Value')*100),'%'),'Position',[10,40,50,20],'BackgroundColor',[1 1 1],'HorizontalAlignment','left','FontName','@Arial UnicodeMS','FontUnits','points','FontSize',10,'FontWeight','Bold');
    ...
    int_airfoil_percent2 = uicontrol('Parent',int_frame2,'Style','text','String',strcat(num2str((1-get(int_airfoil_slider,'Value'))*100),'%'),'Position',[270,40,50,20],'BackgroundColor',[1 1 1],'HorizontalAlignment','Right','FontName','@Arial UnicodeMS','FontUnits','points','FontSize',10,'FontWeight','Bold');
...
%
    ...
    % calculate number of data points and create legend name
    count = length(AOA);
    legendname=strcat(run_filename,' Re-',num2str(Re),' M-',num2str(Mach));
    leg = repmat({legendname},count,1);
